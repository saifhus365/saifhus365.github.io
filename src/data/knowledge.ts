...
export const knowledgePoints: KnowledgePoint[] = [
    ...
    },
    {
        ...
        label: "Chunking & Overlap Strategies",
        category: "NLP & Retrieval",
        description: "Experimenting with document chunking methods, overlap ratios, and split boundaries to maximize retrieval precision and recall from large corpora.",
        ...near("NLP & Retrieval", 0.08, 0.08, -0.08),
        relatedProjects: ["Illumulus"],
        relatedWork: "Systematically tested different chunking sizes, overlap ratios, and splitting strategies on a large Wikipedia corpus to optimize fact retrieval in the Illumulus storytelling AI.",
        tags: ["chunking", "overlap", "splitting", "corpus", "retrieval-quality"],
    },
    {
        id: "retrieval-evaluation",
        label: "Retrieval Precision & Recall",
        category: "NLP & Retrieval",
        description: "Measuring retrieval system quality using precision, recall, and F1 metrics against ground-truth fact sets to validate RAG pipeline configurations.",
        ...near("NLP & Retrieval", 0.00, -0.05, -0.10),
        relatedProjects: ["Illumulus"],
        relatedWork: "Evaluated multiple RAG pipeline configurations against ground-truth facts from Wikipedia, iterating on embeddings and vector DBs to maximize precision and recall for Illumulus.",
        tags: ["precision", "recall", "f1", "ground-truth", "retrieval-evaluation"],
    },
    ...
    },
    {
        ...
        category: "Research & Methods",
        description: "Studying top Kaggle competition submissions, reproducing winning solutions, and benchmarking model performance against public leaderboards.",
        ...near("Research & Methods", 0.10, -0.05, -0.10),
        relatedProjects: ["RetMed"],
        relatedWork: "Studied top VindrCXR Kaggle competition submissions to reverse-engineer winning chest X-ray detection approaches before training own models on HPC.",
        tags: ["kaggle", "competition", "leaderboard", "benchmarking", "sota"],
    },
    {
        id: "map-detection-metrics",
        label: "mAP & Detection Metrics",
        category: "Research & Methods",
        description: "Evaluating object detection models using mean Average Precision (mAP), IoU thresholds, and precision-recall curves for rigorous model comparison.",
        ...near("Research & Methods", -0.05, -0.10, 0.00),
        relatedProjects: ["RetMed", "Deep Learning CV Course"],
        relatedWork: "Systematically evaluated multi-model detection outputs using mAP@[0.5:0.95] on the VindrCXR test set to select final ensemble configuration.",
        tags: ["map", "iou", "precision-recall", "detection-evaluation", "metrics"],
    },
    ...
    },
    {
        ...
        category: "ML & Deep Learning",
        description: "Combining predictions from multiple independently trained models via weighted averaging, NMS, and fusion to boost accuracy beyond any single model.",
        ...near("ML & Deep Learning", 0.10, -0.05, 0.05),
        relatedProjects: ["RetMed"],
        relatedWork: "Trained and ensembled ViT, YOLOv10, and DETR outputs on chest X-ray detection, fusing predictions to surpass top Kaggle VindrCXR leaderboard entries.",
        tags: ["ensemble", "model-fusion", "nms", "weighted-averaging", "boosting"],
    },
    {
        id: "transfer-learning",
        label: "Transfer Learning",
        category: "ML & Deep Learning",
        description: "Adapting pretrained models (ImageNet, COCO) to domain-specific tasks via fine-tuning for faster convergence and stronger performance on limited data.",
        ...near("ML & Deep Learning", -0.05, -0.08, 0.10),
        relatedProjects: ["RetMed", "Deep Learning CV Course"],
        relatedWork: "Applied transfer learning from COCO-pretrained detectors to the medical chest X-ray domain, significantly reducing training time and improving mAP scores.",
        tags: ["transfer-learning", "pretrained", "fine-tuning", "domain-adaptation", "imagenet"],
    },
    {
        id: "hyperparameter-tuning",
        label: "Hyperparameter Tuning",
        category: "ML & Deep Learning",
        description: "Systematic search over learning rates, batch sizes, schedulers, and architecture configs to find optimal training configurations for deep models.",
        ...near("ML & Deep Learning", 0.05, 0.10, -0.08),
        relatedProjects: ["RetMed", "Illumulus"],
        relatedWork: "Iterated on learning rate schedules, batch sizes, and model architectures across multi-week HPC training runs tracked via W&B and MLflow.",
        tags: ["hyperparameter", "tuning", "learning-rate", "grid-search", "optimization"],
    },
    {
        id: "data-augmentation",
        label: "Data Preprocessing & Augmentation",
        category: "ML & Deep Learning",
        description: "Image preprocessing and augmentation pipelines (flips, rotations, color jitter, cutout, mixup) for robust model training on constrained medical datasets.",
        ...near("ML & Deep Learning", 0.08, 0.05, 0.10),
        relatedProjects: ["RetMed", "Deep Learning CV Course"],
        relatedWork: "Built preprocessing and augmentation pipelines for chest X-ray images to boost detection model generalization across the VindrCXR dataset.",
        tags: ["augmentation", "preprocessing", "data-pipeline", "transforms", "generalization"],
    },
    {
        id: "large-scale-training",
        label: "Large-Scale Model Training",
        category: "ML & Deep Learning",
        description: "Managing multi-day and multi-week training runs on GPU clusters with checkpointing, live monitoring, and fault-recovery strategies.",
        ...near("ML & Deep Learning", 0.12, -0.03, -0.05),
        relatedProjects: ["RetMed"],
        relatedWork: "Managed weeks-long training cycles of detection models on HPC GPUs with checkpoint management, W&B monitoring, and iterative performance improvement.",
        tags: ["large-scale", "training", "checkpointing", "gpu-cluster", "fault-recovery"],
    },
    ...
    },
    {
        ...
        label: "HPC & SLURM",
        category: "DevOps & Cloud",
        description: "SSH into university HPC clusters and configure SLURM workload manager for GPU-accelerated batch training at scale with job queuing and resource allocation.",
        ...near("DevOps & Cloud", -0.08, -0.05, -0.08),
        relatedProjects: ["RetMed", "Illumulus"],
        relatedWork: "SSHd into HPC clusters and configured SLURM batch jobs for multi-week GPU training of object detection and embedding models for RetMed and Illumulus.",
        tags: ["hpc", "slurm", "gpu", "batch-jobs", "cluster-computing"],
    },
    {
        id: "shell-scripting",
        label: "Bash & Shell Scripting",
        category: "DevOps & Cloud",
        description: "Writing shell scripts for SLURM job submission, training pipeline automation, remote server management, and reproducible experiment workflows.",
        ...near("DevOps & Cloud", 0.05, -0.10, 0.00),
        relatedProjects: ["RetMed", "Illumulus"],
        relatedWork: "Authored SLURM job scripts, shell automation for multi-model training pipelines, and SSH-based remote monitoring workflows on HPC infrastructure.",
        tags: ["bash", "shell", "scripting", "automation", "slurm-scripts"],
    },
];